<aside id="default-sidebar" class="bg-[#89c7d1] fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 shadow-lg shadow-gray-500" aria-label="Sidebar">
