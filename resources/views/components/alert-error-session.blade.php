<div id="alert-error" class="flex items-center p-4 mb-4 text-sm text-[#ffffff] rounded-lg bg-[#ff9494] shadow-lg fixed top-5 right-5 z-50 justify-center w-fit" role="alert">
    ...
    <button type="button" class="ms-auto -mx-1.5 -my-1.5 text-red-500 rounded-lg p-1.5 hover:bg-red-300 inline-flex items-center justify-center h-8 w-8 " data-dismiss-target="#alert-error" aria-label="Close">
